...
const Banner = () => {
  return <section className=" bg-primary bg-pattern lg:min-h-[768px]
   pt-16 lg:pt-16">
    <div className="container mx-auto min-h-[768px] flex items-center
     justify-center">
      <MouseParallaxContainer globalFactorX={0.4} globalFactorY={0.3}
       resetOnLeave
          ...
          <div className=" flex flex-col lg:flex-row items-center
            ...
            <div className=" flex-1">
              <div className=" font-bangers text-[32px] text-white
               tracking-[0.03em]">Best pizza in town</div>
            <h1 className=" text-6xl lg:text-8xl font-bangers
              drop-shadow-md">Pizza perfection <br /> in every bite</h1>
            </div>
        ...
        <MouseParallaxChild factorX={0.2} factorY={0.3}
         className=" relative">
          ...
          >
           ...
           {/* garlic img 1  */}
          <MouseParallaxChild factorX={0.6} factorY={0.6}
