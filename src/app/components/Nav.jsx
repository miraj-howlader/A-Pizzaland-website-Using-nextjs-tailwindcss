     ...
     <div className=" flex gap-x-8 items-center">
      ...
      <div className=" flex gap-x-3 items-center">
        ...
        <div className=" text-white">
          <div className=" font-robotoCondensed uppercase
           font-medium leading-none text-sm">C/32 Pizza delivery services</div>
          <div className=" text-3xl font-robotoCondensed
            font-extrabold leading-none tracking-wide">+88 017 31458 068</div>
        </div>
      ...
      onClick={()=>setIsOpen(!isOpen)}
       className=" relative cursor-pointer hidden lg:flex">
        ...
        {/* amount  */}
        <div className=" bg-tertiary w-6 h-6 rounded-full
         text-white flex justify-center items-center text-[13px]
          font-robotoCondensed absolute -bottom-2 -right-1">{itemAmount}</div>
      </div>
     </div>
    </div>
  </nav>;
